...
function ModelManagementCard({ model, onToggle, onWeightChange, onTrainComplete }: ModelCardProps) {
  ...
  return (
    <div style={{
      ...
      padding: "20px 24px", opacity: model.enabled ? 1 : 0.55,
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "6px" }}>
          ...
          <span style={{ fontSize: "12px", fontWeight: 600, color: weightColor(weight) }}>{weightLabel(weight)}</span>
        </div>
      ...
      {model.name === "Random Forest" && <RFTrainingPanel onTrainComplete={onTrainComplete} />}
      {model.name === "Isolation Forest" && <IFTrainingPanel onTrainComplete={onTrainComplete} />}
    </div>
  );
}
  ...
  return (
    <div style={{ maxWidth: "860px", margin: "0 auto" }}>
      ...
      <div style={{
        ...
        clogging. The final score is a weighted average of all votes.
      </div>
